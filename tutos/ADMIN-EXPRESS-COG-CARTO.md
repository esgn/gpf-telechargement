...
ogr2ogr communes_pqt.gpkg \
  /vsicurl/https://data.geopf.fr/chunk/telechargement/download/ADMIN-EXPRESS-COG-CARTO-PARTIEL/ADMIN-EXPRESS-COG-CARTO_4-0__GEOPARQUET_WGS84G_FRA_2026-01-01/commune.parquet \
  -where "code_insee_du_departement = '58'"
```
...
ogr2ogr communes_fgb.gpkg \
  "/vsicurl/https://data.geopf.fr/chunk/telechargement/download/ADMIN-EXPRESS-COG-CARTO-PARTIEL/ADMIN-EXPRESS-COG-CARTO_4-0__FLATGEOBUF_WGS84G_FRA_2026-01-01/commune.fgb" \
  -where "code_insee_du_departement = '58'"
```
